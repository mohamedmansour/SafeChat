...
namespace OTRTest
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void OnBobOTRMangerEventHandler(object source, OTREventArgs e)
        {
            ...
            switch (e.GetOTREvent())
            {
                ...
                case OTR_EVENT.ERROR:
                    ...
                    log.Text += String.Format("Bob: OTR Error: {0} \n", e.GetErrorMessage());
                    log.Text += String.Format("Bob: OTR Error Verbose: {0} \n", e.GetErrorVerbose());

                    break;
                case OTR_EVENT.READY:


                    log.Text += String.Format("Bob: Encrypted OTR session with {0} established \n", e.GetSessionID());


                    break;
                case OTR_EVENT.DEBUG:

                    log.Text += String.Format("Bob: " + e.GetMessage() + "\n");
                ...
                case OTR_EVENT.CLOSED:
                    ...
                    log.Text += String.Format("Bob: Encrypted OTR session with {0} closed \n", e.GetSessionID());
        ...
        private void OnAliceOTRMangerEventHandler(object source, OTREventArgs e)
        {
            ...
            switch (e.GetOTREvent())
            {
                ...
                case OTR_EVENT.ERROR:
                    ...
                    log.Text += String.Format("Alice: OTR Error: {0} \n", e.GetErrorMessage());
                    log.Text += String.Format("Alice: OTR Error Verbose: {0} \n", e.GetErrorVerbose());

                    break;
                case OTR_EVENT.READY:


                    log.Text += String.Format("Alice: Encrypted OTR session with {0} established \n", e.GetSessionID());
                ...
                case OTR_EVENT.DEBUG:
                    ...
                    log.Text += String.Format("Alice: " + e.GetMessage() + "\n");
                ...
                case OTR_EVENT.CLOSED:
                    ...
                    log.Text += String.Format("Alice: Encrypted OTR session with {0} closed \n", e.GetSessionID());
        ...
        private void SendDataOnNetwork(string my_unique_id, string otr_data)
        {
            ...
            {
                log.Text += String.Format("Encrypted data: {0}\n ", otr_data);
